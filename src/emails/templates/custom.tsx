...
import { Html, Tailwind, pixelBasedPreset, Head, Preview, Body, Container, Heading, Section, Text } from "@react-email/components";
                ...
                <Body className="m-0 bg-white p-0 font-sans text-base leading-normal">
                    ...
                    <Container className="mx-auto bg-white px-5">
                        ...
                        <Section className="py-8">
                            <Text>Dear <strong>{props.firstName}</strong>,</Text>
                            {paragraphs.map((p, i) => <Text key={i} className="my-4 whitespace-pre-line">{p}</Text>)}
                        </Section>
                    </Container>
                    <Footer />
                </Body>
