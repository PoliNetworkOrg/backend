...
const FIRST_NAMES = [
  "Marco", "Luca", "Giulia", "Sara", "Andrea", "Francesca", "Alessandro", "Chiara", "Matteo", "Elena",
  "Davide", "Sofia", "Simone", "Martina", "Riccardo", "Giorgia", "Federico", "Valentina", "Lorenzo", "Beatrice",
]
const LAST_NAMES = [
  "Rossi", "Bianchi", "Ferrari", "Russo", "Colombo", "Ricci", "Marino", "Greco", "Bruno", "Gallo",
  "Conti", "De Luca", "Costa", "Giordano", "Mancini", "Rizzo", "Lombardi", "Moretti", "Barbieri", "Fontana",
]
const LANG_CODES = ["it", "en", "es", "fr", "de"]
const GROUP_TOPICS = [
  "Ingegneria", "Informatica", "Matematica", "Fisica", "Design", "Architettura", "Chimica", "Economia", "Biologia", "Medicina",
]
...
const messages = users.flatMap((user) =>
  Array.from({ length: MESSAGES_PER_USER }, () => {
    ...
    return {
      ...
      message: randomItem(MESSAGE_TEMPLATES),
    }
  })
)
